...
// import "./profile.css";
import Restaurant_main from "./restaurant/Restaurant_main";
...
function Profile_main() {
  ...
  if (restaurant == 1) {
    return <Restaurant_main clickBtn={clickBtn} />;
  } else {
    return (
      <div className="container-fluid">
        ...
        <div className="row">
          <div className="col-md-12" style={{ marginTop: "80px" }}>
            ...
            <h4>
              Hello, I am Nitesh. I design & develop website and I Love what I
              do.
            </h4>
          </div>
        </div>
          ...
          <center>
            <div className="col-md-8">
              ...
              <p className="mt-5" style={{ fontSize: "1.2em" }}>
                Since beginning my journey as a designer nearly 3 years ago,
                I've done work for startups, corporate companies and
                collaborated with talented people to create digital products for
                both business and consumer use. I'm quietly confident, naturally
                curious, and perpetually working on improving my chops one
        ...
        <div className="row mt-2" id="project">
          <div className="col-12">
            ...
            <h4>Here are a few design projects I've worked on recently. </h4>
          </div>
